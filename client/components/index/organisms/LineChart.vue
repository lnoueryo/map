...
export default Vue.extend({
    ...
    computed: {
        ...
        population(){
            return this.$store.getters['home/population']
        },
        lineChartIndex(){
            return this.$store.getters['home/lineChartIndex']
        },
    },
    watch: {
        windowSize: {
    ...
    methods:{
        ...
        resetChart(){
            ...
            this.data = Object.assign({}, this.data, this.population[this.lineChartIndex]);
            this.verticalAxis = [];
            this.verticalAxis = this.verticalAxis.concat(this.population[this.lineChartIndex].population)
