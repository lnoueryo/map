<template>
    <div>
        ...
        <div id="drawer-button-wrapper">
            <circle-button v-if="!drawerClass.open" class="animation" @click.native="onClickCircleButton" :style="drawerClass.open ? {transform:'translate(-306px,-56px)'} : ''">
                <div class="down-icon rotate"></div>
            </circle-button>
        </div>
    </div>
</template>
