...
export default Vue.extend({
    ...
    computed: {
        ...
        selectCompany: {
            ...
            set(value) {
                this.$store.dispatch('city/selectedCompanyItems', value)
            }
        },
        selectLine: {
            get() {
            ...
            set(value) {
                this.$store.dispatch('city/selectedLineItems', value)
            }
        }
    },
    methods:{
        selectStationMarker(obj: {name: string}) {
            ...
            this.$store.dispatch('city/selectMarker', obj);
        },
        ...
        select(searchStation: Station) {
            ...
            this.$store.dispatch('city/selectMarker',searchStation);
        },
