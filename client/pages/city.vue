...
<script lang="ts">
import Vue from 'vue'
const RightDrawer = () => import('../components/city/templates/RightDrawer.vue');
const LeftList = () => import('../components/city/templates/LeftList.vue');
const MapView = () => import('../components/city/templates/Map.vue');
const TopBar = () => import('../components/city/templates/TopBar.vue');
const Bottom = () => import('../components/city/templates/Bottom.vue');
